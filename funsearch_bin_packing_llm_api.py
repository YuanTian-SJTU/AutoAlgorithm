...
if __name__ == '__main__':
    ...
    with open('E:/学生指导/24本科毕设/毕设材料/毕设材料_姜天宇0618/Case1_FixedTimeMaxCoverage/specification_new_5.py') as f:
    ...
    global_max_sample_num = 2  # if it is set to None, funsearch will execute an endless loop
    funsearch.main(
